...
export default function AboutMe() {
  return (
    <>
      ...
      <main className='flex flex-wrap italic font-body justify-evenly items-center bg-lightGray md:pb-4'>
        <img
          className='mt-5 m-auto w-80 rounded-lg'
          src={heather}
          alt='Heather'
        />
        <p className='m-5 max-w-xl text-left font-body leading-10'>
